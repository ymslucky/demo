// Shared utility functions for tools page.
// Extracted from ToolsClient.tsx so they can be unit-tested independently.
...
/**
 * Compute a unit conversion result.
 * For temperature, the offset-based formula is used.
 * For other categories, simple factor multiplication applies.
 */
