  ...
  synchronized boolean tryAcquire() {
    ...
    return false;
        ...
        <div style={{ overflowX: 'auto', marginBottom: '2rem' }}>
          <table style={{
            ...
            <tbody>
              {[
                ...
                <tr key={row[0]} style={{ background: i % 2 === 1 ? 'var(--color-tint)' : 'transparent' }}>
                  {row.map((cell, j) => (
                    <td key={j} style={{
                      padding: '0.6rem 0.75rem',
                      borderBottom: i === 3 ? '3px solid var(--color-border)' : 'none',
          ...
          <p style={{ textAlign: 'center', fontSize: 'var(--fs-sm)', color: 'var(--color-text-muted)', marginTop: '0.75rem' }}>
        ...
        <figure style={{ margin: '2rem 0 3rem' }}>
          <RateLimiterDemo />
          <figcaption style={{
            textAlign: 'center',
            fontSize: 'var(--fs-sm)',
